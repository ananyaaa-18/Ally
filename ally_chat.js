  ...
  firebase.database().ref("/"+room_name).on('value', function(snapshot) {
    ...
    snapshot.forEach(function(childSnapshot) {
       ...
       if(childKey != "purpose")
       {
         ...
         row = "<h4> "+ name +"<img class='user_tick' src='hiii-removebg-preview.png'></h4><h4 class='message_h4'>"+ message +"</h4><button class='btn btn-warning' id='"+firebase_message_id+"' value='"+like+"' onclick='updateLike(this.id)'><span class='glyphicon glyphicon-thumbs-up'>Like: "+ like +"</span></button><hr>";       
